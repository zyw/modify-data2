...
public class NetworkUtil {
    ...
    /**
     * 全部物理网卡MAC地址字符串
     * @return 例如：26:d8:a9:4f:50:c7,60:f8:1d:bf:51:04
     */
    public static String allphyicalMACString() {
        return Joiner.on(",")
                .join(
                        NetworkUtil.getPhysicalNICs().stream()
                                .map(item -> NetworkUtil.getMacAddress(item, ":"))
